...
public class ControlUnknownFunction implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        functions = FXCollections.observableArrayList("sin", "cos", "tan", "ln", "exp", "none");
        choiceBox.setItems(functions);
    ...
    public void create() {
        try {
            ...
            Main.baseFunction = getChoiceFunction();
    ...
    private Function getChoiceFunction(){
